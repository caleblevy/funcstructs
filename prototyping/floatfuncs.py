...
prevfloat = lambda f: np.nextafter(f, -Inf, dytpe=np.float16)
...
FinitePositives = FloatSet(Positives[:-1])
FiniteNonNegatives = FloatSet(NonNegatives[:-1])
FiniteNegatives = FloatSet(Negatives[1:])
FiniteNonPositives = FloatSet(NonPositives[1:])
